...
//	);
	...
	public Kurly_reviewVO() {;}
	
	
	
	

	public Kurly_reviewVO(String id, String goodscode, String  reviewnum, String reviewcontents, String reviewimage,
	...
	public Kurly_reviewVO(String  reviewnum, String reviewcontents, String reviewimage) {
		super();
		this.reviewnum = reviewnum;
		this.reviewcontents = reviewcontents;
		this.reviewimage = reviewimage;
