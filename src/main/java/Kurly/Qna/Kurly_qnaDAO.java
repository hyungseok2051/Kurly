...
public class Kurly_qnaDAO {
	...
	public List<Kurly_qnaVO> selectAllQna(String gcode1) {
		List<Kurly_qnaVO> QnaList = new ArrayList();
		try {
			conn = dataFactory.getConnection();
			String query = "select * from hr.kurly_qna where goodscode = ?";
	...
	public int getTotal(Kurly_qnaVO qnaVO) {
		try {
...
//	}
	...
	//1:1문의 작성하기
	public void insertQna(Kurly_qnaVO qnaVO) {
		try {
		conn = dataFactory.getConnection();
		...
		String query = "INSERT INTO hr.kurly_qna (id, name, goodscode, qnatitle, qnacontents,qnanum)"
	...
	//1:1 문의 수정할 게시글 들고오기
	public Kurly_qnaVO findqna(String _qnanum) {
		Kurly_qnaVO findqna=null;
		try {
			conn = dataFactory.getConnection();
			...
			findqna = new Kurly_qnaVO(id, name, goodscode, qnatitle, qnacontents, qnanum);
	...
	//1:1 문의 작성한 게시글 수정하기
	public void updateQna(Kurly_qnaVO qnaVO) {
		try {
			conn = dataFactory.getConnection();
			String id = qnaVO.getId();
			String name = qnaVO.getName();
