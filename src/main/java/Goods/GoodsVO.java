...
//	"GOODSORGIN" VARCHAR2(4000 BYTE), --11.원산지
...
//	"GOODSSTOCK" NUMBER(10,0) DEFAULT 200 --17.재고
	...
	public GoodsVO(String goodscode, String goodsimgage, String goodsname, String goodsinfo, int goodsprice,
			String goodsdiscount, String goodsdelivery, String goodspackage, String goodsunit, String goodsweight,
			String goodsorgin, String goodsselect, String goodscontents1, String goodscontents2, String goodscontents3,
			String goodscontents4, int goodsstock) {
		super();
		this.goodscode = goodscode;
		this.goodsimgage = goodsimgage;
	...
	//상품이미지
	public GoodsVO(String goodsimgage) {
		super();
		this.goodsimgage = goodsimgage;
	}
	...
	public String getGoodsimgage() {
		return goodsimgage;
	}

	public void setGoodsimgage(String goodsimgage) {
		this.goodsimgage = goodsimgage;
	}
...
//	${gcode.goodsorgin}
//	${gcode.goodsselect}
//	${gcode.goodscontents1}
//	${gcode.goodscontents2}
//	${gcode.goodscontents3}
//	${gcode.goodscontents4}
//	${gcode.goodscontents5}
//	${gcode.goodsstock}
