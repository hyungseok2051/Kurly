        ...
        <c:forEach var="gdetail" items="${gdetail}">
            <article class="product-information-area">
                <div class="left-img-area">
                	<img src="${contextPath}/컬리이미지/${gdetail.goodsimgage}" alt="가지상세이미지">
                </div><!--12.상품 메인이미지 goodsimgage-->
                <input type="hidden" value="${gdetail.goodscode}">   <!--1.상품코드-->                               
                <div class="right-information-area">
                    ...
                    <div class="sales-content">
                        ...
                        <dl class="sales-content-list">
                            ...
                            <dd class="sales-content-list-child2">
                                <!--10. 원산지 goodsorgin-->
                                <p class="sales-content-list-p">${gdetail.goodsorgin}</p>
                            </dd>                         
       ...
       <div class="product-description-frame">
          <div class="gaji-description">
                    <div class="gaji-description-1">
                        <div class="gaji-description-2">
                            ...
                            <div class="gaji-intro">
                                <div class="gaji-pic">
                                    <img src="${contextPath}/상세페이지/${gdetail.goodscontents1}">
                                </div>
                            </div>
                            ...
                            <div class="gaji-point">
                                ...
                                <div class="gaji-context">
                                    <div class="gaji-pic">
                                        <img src="${contextPath}/상세페이지/${gdetail.goodscontents2}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="gaji-desc">
                                <div class="gaji-context">
                                    <div class="gaji-pic">
                                        <img src="${contextPath}/상세페이지/${gdetail.goodscontents3}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="gaji-detail">
                    ...
                    <div class="gaji-detail-list1"><img src="${contextPath}/상세페이지/${gdetail.goodscontents4}" alt="크기사진"></div>
                            ...
                            <table class="user-inquiry-post-area">
                                            ...
                                            <div class="user-inquiry-qnaQ-frame">
                                                <div class="user-inquiry-qnaQ-area">                                                    
                                                    <div class="user-inquiry-qnaQ-text">
                                                        <img class="stop-selling" src="컬리이미지/기타/공지사항.webp" alt="판매중단제품">
                                                    </div>
                                                </div>
                                ...
                                <c:forEach var="Qlist" items="${Qlist}">
                                    <tr class="user-inquiry-post">
                                        ...
                                        <td class="user-inquiry-post-status-clear"><a href="${contextPath}/good1/qndDel.do?qnanum=${Qlist.qnanum}">삭제하기</a></td>
                                    </tr>
