	   ...
	   <form action="${contextPath}/good1/insertReview.do?goodscode=${goodscode}" method="post" name="writeForm" enctype="multipart/form-data">
			...
			<div class="files">
				<div>
					<label for="board_file1" style="display: inline;"> <img
						id="board_file1Img"
						src="${pageContext.request.contextPath}/images/filePlus.png"
						width="110px" height="110px" style="display: inline;">
					</label>
				</div>
				<input id="board_file1" name="reviewimage" type="file"> 
		...
		<table border="1">
	         ...
	         <tr>
	            ...
	            <td colspan="2"><img src="${contextPath}/컬리이미지/${goodsimg.goodsimgage}"></td>
	         </tr>
